...
test("business identity and customer-service details are visible site-wide", () => {
  assert.match(html, /class="sw-footer-business"/);
  assert.match(html, /124 City Road, London, EC1V 2NX/);
  assert.match(html, /VAT GB 520 4679 02/);
...
test("customers and crawlers can reach dedicated trust pages", () => {
  for (const path of ["/about/", "/contact/", "/delivery/", "/returns/", "/terms-and-conditions/", "/privacy-policy/"]) {
